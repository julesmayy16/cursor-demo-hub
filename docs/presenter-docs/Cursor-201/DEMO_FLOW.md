...
<!-- @include: docs/presenter-docs/Features/Rules/Rules.md | after: ## Overview, collapsible: true, label: Rules Details -->
...
<!-- @include: docs/presenter-docs/Features/Agent/Plan-Mode/Plan-Mode.md | after: ## Setup, collapsible: true, label: Plan Mode Details -->
